...
(
    ...
    `avatar`     varchar(128) null default '' comment '用户头像',
    `background_image` varchar(128) null default '' comment '用户个人页顶部大图',
    `signature`     varchar(128) null default '' comment '个人简介',
